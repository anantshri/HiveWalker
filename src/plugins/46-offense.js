...
(function (RV) {
  ...
  const AUTOSTART_SOURCES = [
    ...
    { label: 'LSA: Security Packages', hives: ['system'], ccs: true, path: '\\Control\\Lsa', values: ['Security Packages'], mitre: 'T1101' },
    ...
    { label: 'Netsh helpers', hives: ['software'], path: 'Microsoft\\Netsh', values: null, mitre: 'T1128' },
